...
namespace System.Reactive.Management.Instrumentation.Linq
{
    ...
    public sealed class WqlQbservableSource<T> : ISource, IQbservable<T>
    {
        ...
        internal WqlQbservableSource(string className, TextWriter logger)
        {
            ...
            queryExpression = Expression.Constant(this);
        }
        ...
        public IDisposable Subscribe(IObserver<T> observer)
        {
            ...
            var ops = FindOperators.Find(queryExpression);
        ...
        /// </summary>
        private class FindOperators : ExpressionVisitor
        {
            /// <summary>
            /// Qbservable's generic Where operator method.
            /// </summary>
            private static MethodInfo methodWhere = Helpers.InfoOf((IQbservable<int> o) => o.Where(i => true)).GetGenericMethodDefinition();

            /// <summary>
            /// Qbservable's generic Select operator method.
            /// </summary>
            private static MethodInfo methodSelect = Helpers.InfoOf((IQbservable<int> o) => o.Select(i => i)).GetGenericMethodDefinition();
